package com.example.daggeringarround;
...
public class BaseActivity extends DaggerAppCompatActivity {
    ...
    private void subscribeObservers(){sessionManager.getAuthUser().observe(this, new Observer<AuthResource<User>>() {
        @Override
